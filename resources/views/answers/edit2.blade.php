        ...
        <form method="POST">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <input id="text" name="text" placeholder="Ingrese pregunta" type="text" class="form-control"  value="{{$respuesta->text}}" style="height: 100px">
            </div>
          </div>
          <div class="form-group">
            <label for="points"> Puntos </label>
            <div class="input-group">
              <input id="points" name="points" placeholder="Ingrese los puntos" type="number" class="form-control" value="{{$respuesta->points}}">
            </div>
          </div>
          <div class="form-group">
